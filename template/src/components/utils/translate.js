...
let docStyle = typeof document !== 'undefined' ? document.documentElement.style : {}
let engine
...
let helperElem = typeof document !== 'undefined' ? document.createElement('div') : {}
...
let transitionEndProperty = toLower(vendorPrefix) + 'TransitionEnd'
